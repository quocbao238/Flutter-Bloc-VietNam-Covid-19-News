        ...
        InkWell(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                Icon(icon, color: ThemePrimary.textPrimaryColor, size: 24.0),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ...MenuTabItem.listMenuItem
                .map((e) =>
                    _item(title: e.appBarTitle, icon: e.iconData, onTap: () {}))
                .toList(),
            Expanded(
              child: Align(
